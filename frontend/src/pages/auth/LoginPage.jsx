...
const LoginPage = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      // Submit directly without the custom hook for more direct control
      setLoginDisabled(true);
      
      // Pass email, password and rememberMe preference to login
      ...
      // Ensure login button is re-enabled for errors other than rate limiting
      if (error.response?.status !== 429) {
        setLoginDisabled(false);
      }
    }
