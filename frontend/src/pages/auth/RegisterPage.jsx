...
const RegisterPage = () => {
  ...
  // Use the custom form submit hook
  const { loading, error: apiError, setError: setApiError, handleSubmit } = useFormSubmit(
    async (data) => {
  ...
  const onSubmit = async (e) => {
    ...
    // Use the handleSubmit function from our custom hook
    try {
      await handleSubmit(e, formData);
    } catch (error) {
      console.error('Registration error:', error);
      // Error handling is now in the submitFn of useFormSubmit
    }
  };
        ...
        <div className="w-full md:w-3/5 lg:w-1/2 p-6 sm:p-8 md:p-10">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="name" className={`block mb-1.5 sm:mb-2 text-sm font-medium ${
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="confirmPassword" className={`block mb-1.5 sm:mb-2 text-sm font-medium ${
                isDark ? 'text-gray-300' : 'text-gray-900'
              }`}>
                Confirm Password
              </label>
            ...
            <motion.div variants={itemVariants} className="flex items-start">
              ...
              <label htmlFor="agreeToTerms" className={`ms-2 text-sm font-medium ${
                isDark ? 'text-gray-300' : 'text-gray-900'
              }`}>
                I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-400 dark:hover:text-blue-300">terms and conditions</a>
              </label>
            </motion.div>
            <AnimatePresence>
              {touched.agreeToTerms && errors.agreeToTerms && (
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between">
              <div className="text-sm">
                <span className={`${isDark ? 'text-gray-300' : 'text-gray-500'}`}>Already have an account?</span>{' '}
        ...
        <div className="hidden md:block md:w-2/5 lg:w-1/2 bg-gradient-to-br from-blue-600 to-cyan-600 p-8 md:p-10 lg:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              ...
              >
                Create your account to access our powerful attendance tracking system. Manage students, generate reports, and gain valuable insights.
              </motion.p>
