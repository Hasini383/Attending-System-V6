          ...
          >
            <div className="px-4 py-4 sm:py-5 sm:px-6 border-b border-gray-200 dark:border-slate-700">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900 dark:text-white">Profile Settings</h3>
                  ...
                  >
                    {profileLoading ? (
                      <span className="flex items-center">
                        <svg className="animate-spin -ml-1 mr-2 h-3 w-3 sm:h-5 sm:w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          >
            <div className="px-4 py-4 sm:py-5 sm:px-6 border-b border-gray-200 dark:border-slate-700">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900 dark:text-white">Password Settings</h3>
                  <p className="mt-1 max-w-2xl text-xs sm:text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="px-4 py-4 sm:py-5 sm:p-6">
              <form onSubmit={handlePasswordSubmit} className="space-y-4 sm:space-y-6">
                <div className="space-y-4">
                  <div>
                    <label htmlFor="currentPassword" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">
                      Current Password
                    </label>
                    <input
                      type="password"
                  ...
                  <div>
                    <label htmlFor="newPassword" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">
                      New Password
                    </label>
                    <input
                      type="password"
          ...
          >
            <div className="px-4 py-4 sm:py-5 sm:px-6 border-b border-gray-200 dark:border-slate-700">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900 dark:text-white">Application Settings</h3>
                  <p className="mt-1 max-w-2xl text-xs sm:text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="border-t border-gray-200 dark:border-slate-700">
              <dl>
                <div className="bg-gray-50 dark:bg-slate-700/30 px-4 py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-300">Theme</dt>
                  <dd className="mt-1 text-xs sm:text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        <div className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">Appearance</div>
                ...
                <div className="bg-white dark:bg-slate-800 px-4 py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-300">Notifications</dt>
                  <dd className="mt-1 text-xs sm:text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    <div className="flex items-center">
                      <button
                        type="button"
                        className="bg-gray-200 dark:bg-slate-600 relative inline-flex flex-shrink-0 h-5 w-10 sm:h-6 sm:w-11 border-2 border-transparent rounded-full cursor-not-allowed"
                        disabled
                      >
                        <span className="translate-x-0 pointer-events-none inline-block h-4 w-4 sm:h-5 sm:w-5 rounded-full bg-white dark:bg-slate-400 shadow transform ring-0 transition ease-in-out duration-200"></span>
                      </button>
                      <span className="ml-2 sm:ml-3 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                        Email notifications
                        <span className="inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-slate-700 text-gray-800 dark:text-gray-200 ml-1 sm:ml-2">
                          Coming Soon
                        </span>
                      </span>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-slate-700/30 px-4 py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-300">Language</dt>
                  <dd className="mt-1 text-xs sm:text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                    <select
                      id="language"
                      name="language"
                      className="mt-1 block w-full pl-3 pr-10 py-1.5 sm:py-2 text-xs sm:text-sm border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
                    ...
                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      <span className="inline-flex items-center px-2 py-0.5 sm:px-2.5 sm:py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-slate-700 text-gray-800 dark:text-gray-200">
                        Coming Soon
                      </span>
                    </p>
                  </dd>
