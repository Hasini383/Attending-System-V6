...
/**
 * Component to display attendance status with an appropriate badge style and icon
 * 
 * @param {Object} props
 * @param {string} props.status - The attendance status ('present', 'absent', 'entered', 'left')
 */
